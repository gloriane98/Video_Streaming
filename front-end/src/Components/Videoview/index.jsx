...
const Videoview = ({socket}) => {
  ...
  const fetchPlaylist = () => {
    fetch(
      `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&relatedToVideoId=${videoId}&safeSearch=none&type=video&key=${
          ...
          {video.items?.map((video) => {
            ...
            return (
              <HashLink
                ...
                className="videoCard"
                to={`/videoview/${video.id.videoId}#read`}
              >
